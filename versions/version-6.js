...
const staticCopy = {
  ".hero h1": {
    en: "I work between image-making technology and unseen faith.",
    ko: "이미지를 만드는 기술과 보이지 않는 믿음 사이에서 작업합니다.",
  },
  "#identity .identity-profile > p": {
    en: "I am an explorer who thinks and creates around three axes: technology, art, and faith. As a generative AI research engineer, I build tools that support creative processes, and I also write essays and fiction.",
    ko: "기술과 예술, 신앙이라는 세 축을 중심으로 생각하고 창작하는 탐구자입니다. 생성형 AI 연구 엔지니어로 창작 과정에 도움을 줄 수 있는 AI 도구를 만들고, 때로는 에세이와 소설을 씁니다.",
  },
  "#career-heading": { en: "Career", ko: "Career" },
  "#education-heading": { en: "Education", ko: "Education" },
  ...
  "#career .cv-group:last-child article:nth-child(1) p": {
    en: "POSTECH, M.S. in Computer Graphics",
    ko: "포항공과대학교 POSTECH, 컴퓨터 그래픽스 석사",
  },
  "#career .cv-group:last-child article:nth-child(3) p": {
    en: "Handong Global University, B.S. in Computer Science, Summa Cum Laude, GPA 4.08 / 4.50",
    ko: "한동대학교 HGU, 컴퓨터공학 학사, Summa Cum Laude, GPA 4.08 / 4.50",
  },
  ...
  "#gallery .section-note": {
    en: "Automatically loads markdown items with <code>type: gallery</code> in frontmatter.",
    ko: "markdown frontmatter의 <code>type: gallery</code> 항목을 자동으로 불러옵니다.",
  },
  "#essay .section-note": {
    en: "Automatically loads markdown items with <code>type: essay</code> in frontmatter. PDF items render directly in the popup.",
    ko: "markdown frontmatter의 <code>type: essay</code> 항목을 자동으로 불러옵니다. PDF 형식은 팝업 안에서 바로 렌더링됩니다.",
  },
  "#paper .section-note": {
    en: "Automatically loads markdown items with <code>type: paper</code> in frontmatter. PDF items render in the dedicated PDF popup.",
    ko: "markdown frontmatter의 <code>type: paper</code> 항목을 자동으로 불러옵니다. PDF 형식은 PDF 전용 팝업에서 렌더링됩니다.",
  },
  "#writing .section-note": {
    en: "Automatically loads markdown items with <code>type: novel</code> in frontmatter. The existing Notion rendering remains as a secondary option.",
    ko: "markdown frontmatter의 <code>type: novel</code> 항목을 자동으로 불러옵니다. 기존 Notion 렌더링은 보조 옵션으로 남겨두었습니다.",
  },
